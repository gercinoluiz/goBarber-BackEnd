...
let EtherealMailProvider = (_dec = (0, _tsyringe.injectable)(), _dec2 = function (target, key) {
  ...
  constructor(mailTemplateProvider) {
    ...
    _nodemailer.default.createTestAccount().then(account => {
      const transporter = _nodemailer.default.createTransport({
        ...
        // All of this is created by default by nodemailer
  ...
  async sendMail({
    ...
    const message = await this.client.sendMail({
      from: {
        name: (from === null || from === void 0 ? void 0 : from.name) || 'Equipe Go Barber',
        address: (from === null || from === void 0 ? void 0 : from.email) || 'equipegobarber@example.com'
      },
      to: {
        name: to.name,
        address: to.email
